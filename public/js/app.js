...
const socket = io('https://sampark6.herokuapp.com', { query: { roomId, peerName } });
  ...
  consumer.receive(recvTransport)
    .then((track) => {
      ...
      if (consumer.kind === 'video') {
        ...
        video.setAttribute('src', 'https://interactive-examples.mdn.mozilla.net/media/examples/flower.webm'),
